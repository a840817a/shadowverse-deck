//
//  UnlimitedTableViewController.swift
//  SVDeck
//
...
class UnlimitedTableViewController: UITableViewController {
    ...
    @IBAction func goBackToDeckIndex(segue: UIStoryboardSegue) {
        if let controller = segue.source as? AddDeckTableViewController {
            ...
            Deck.saveToFile(decks: decks, mode: "Unlimited")
    ...
    override func viewDidLoad() {
        ...
        if let decks = Deck.readFromFile(mode: "Unlimited") {
            self.decks = decks
        }
    }
